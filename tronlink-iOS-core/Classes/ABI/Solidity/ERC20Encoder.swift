...
/// Encodes ERC20 function calls. Parameterized helpers throw on invalid input.
public final class ERC20Encoder {
    ...
    public static func encodeBalanceOf(address: Address) throws -> Data {
        let function = Function(name: "balanceOf", parameters: [.address])
        return try encode(function: function, arguments: [address])
    }
    ...
    public static func encodeAllowance(owner: Address, spender: Address) throws -> Data {
        let function = Function(name: "allowance", parameters: [.address, .address])
        return try encode(function: function, arguments: [owner, spender])
    }
    ...
    public static func encodeTransfer(to: Address, tokens: BigUInt) throws -> Data {
        let function = Function(name: "transfer", parameters: [.address, .uint(bits: 256)])
        return try encode(function: function, arguments: [to, tokens])
    }
    ...
    public static func encodeApprove(spender: Address, tokens: BigUInt) throws -> Data {
        let function = Function(name: "approve", parameters: [.address, .uint(bits: 256)])
        return try encode(function: function, arguments: [spender, tokens])
    }
    ...
    public static func encodeTransfer(from: Address, to: Address, tokens: BigUInt) throws -> Data {
        let function = Function(name: "transferFrom", parameters: [.address, .address, .uint(bits: 256)])
        return try encode(function: function, arguments: [from, to, tokens])
    }
    ...
    public static func encodeDepositTRX() -> Data {
        return encodeSelector("depositTRX()")
    }
    ...
    public static func encodeDepositTRC10(tokenId: BigUInt, tokens: BigUInt) throws -> Data {
        let function = Function(name: "depositTRC10", parameters: [.uint(bits: 64), .uint(bits: 64)])
        return try encode(function: function, arguments: [tokenId, tokens])
    }
    ...
    public static func encodeDepositTRC20(spender: Address, tokens: BigUInt) throws -> Data {
    ...
    public static func encodeWithdrawTRX() -> Data {
        return encodeSelector("withdrawTRX()")
    }
    ...
    public static func encodeWithdrawFee() -> Data {
        return encodeSelector("getWithdrawFee()")
    }
    ...
    public static func encodeWithdrawTRC10(tokenId: BigUInt, tokens: BigUInt) throws -> Data {
    ...
    public static func encodeWithdrawTRC20(tokens: BigUInt) throws -> Data {
        let function = Function(name: "withdrawal", parameters: [.uint(bits: 256)])
        return try encode(function: function, arguments: [tokens])
    }
    ...
    public static func encodeExchangeBalance(contractOwner: Address, tokens: [Address]) throws -> Data {
        let function = Function(name: "getBalance", parameters: [.address, .dynamicArray(.address)])
        return try encode(function: function, arguments: [contractOwner, tokens])
    }
    ...
    public static func encodetTrxToTokenSwapInput(minTokens: BigUInt, deadline: BigUInt) throws -> Data {
        let function = Function(name: "trxToTokenSwapInput", parameters: [.uint(bits: 256), .uint(bits: 256)])
        return try encode(function: function, arguments: [minTokens, deadline])
    }
    ...
    public static func encodetTrxToTokenSwapOutput(tokensBought: BigUInt, deadline: BigUInt) throws -> Data {
        let function = Function(name: "trxToTokenSwapOutput", parameters: [.uint(bits: 256), .uint(bits: 256)])
        return try encode(function: function, arguments: [tokensBought, deadline])
    }
    ...
    public static func encodeTokenToTrxSwapInput(tokensSold: BigUInt, minTrx: BigUInt, deadline: BigUInt) throws -> Data {
        let function = Function(name: "tokenToTrxSwapInput", parameters: [.uint(bits: 256), .uint(bits: 256), .uint(bits: 256)])
        return try encode(function: function, arguments: [tokensSold, minTrx, deadline])
    }
    ...
    public static func encodeTokenToTrxSwapOutput(trxBought: BigUInt, maxTokens: BigUInt, deadline: BigUInt) throws -> Data {
        let function = Function(name: "tokenToTrxSwapOutput", parameters: [.uint(bits: 256), .uint(bits: 256), .uint(bits: 256)])
        return try encode(function: function, arguments: [trxBought, maxTokens, deadline])
    }
    ...
    public static func encodeTokenToTokenSwapInput(tokensSold: BigUInt, minTokensBought: BigUInt, minTrxBought: BigUInt, deadline: BigUInt, tokenAddr: Address) throws -> Data {
        ...
        return try encode(function: function, arguments: [tokensSold, minTokensBought, minTrxBought, deadline, tokenAddr])
    }
    ...
    public static func encodeTokenToTokenSwapOutput(tokensBought: BigUInt, maxTokensSold: BigUInt, maxTrxSold: BigUInt, deadline: BigUInt, tokenAddr: Address) throws -> Data {
        ...
        return try encode(function: function, arguments: [tokensBought, maxTokensSold, maxTrxSold, deadline, tokenAddr])
    }
    
    /// Encodes a function call to `queryDIDAddress`
    ///
    /// Solidity function: `function queryDIDAddress(String did) public returns (address);`
    public static func encodeQueryDIDAddress(did: String) throws -> Data {
        let function = Function(name: "queryAddress", parameters: [.string])
        return try encode(function: function, arguments: [did])
    }
    ...
    public static func encodeSwapExactInput(path: [Address],
        ...
        return try encode(function: function, arguments: [path, poolVersion, versionLen, fees, tuple])
    }

    /// Encodes a function call to `ownerOf`
    ///
    /// Solidity function: `function ownerOf(uint256) public returns (address);`
    public static func encodeOwnerOf(tokenId: BigUInt) throws -> Data {
        let function = Function(name: "ownerOf", parameters: [.uint(bits: 256)])
        return try encode(function: function, arguments: [tokenId])
    }

    private static func encodeSelector(_ signature: String) -> Data {
        return Data(EthereumCrypto.hash(Data(signature.utf8)).prefix(4))
    }

    /// Returns complete calldata or propagates the encoding error to the caller.
    private static func encode(function: Function, arguments: [Any]) throws -> Data {
